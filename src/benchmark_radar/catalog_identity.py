...
DEFAULT_IDENTITY_PATH = Path("data/catalog/identity.yml")
DEFAULT_CANDIDATES_PATH = Path("data/catalog/identity_candidates.yml")
...
def write_identity_candidates(candidates: dict[str, Any], output: Path) -> Path:
    ...
    header = (
        "# Generated by `benchmark-radar normalize-catalog`. NOT loaded by the\n"
